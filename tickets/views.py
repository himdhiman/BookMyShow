...
from tickets.models import Booking, BookedSeat, Seat
from cinema.models import Show
from tickets.forms import SeatForm, BookingForm
from django.urls import reverse_lazy
import datetime
from django.views.generic import ListView,DetailView,DeleteView
from cinema.models import Theatre
...
def reserve_seat(request, show_id):
    ...
    return render(request, 'tickets/reserve_seat.html', context)
    ...
    if request.POST:
        ...
        for each in seats:
            if Seat.objects.filter(no=each, show=show).exists():
                return render(request, 'tickets/reserve_seat.html', 
        ...
        return render(request, 'tickets/payment_gateway.html', 
